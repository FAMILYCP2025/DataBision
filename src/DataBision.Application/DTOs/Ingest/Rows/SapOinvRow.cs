...
/// <summary>SAP B1 OINV — AR Invoice header (réplica idempotente).</summary>
public sealed class SapOinvRow : IIngestRow
{
    // Business columns
    ...
    // Watermark columns (CreateTS / UpdateTS arrive as int or string from SAP; UpdateTSNorm is authoritative CHAR(6))
    ...
    // Technical fields (excluded from canonical hash by CanonicalHasher)
